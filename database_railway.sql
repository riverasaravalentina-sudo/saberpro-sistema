...
-- ===============================
-- IMPORTANTE: Railway ya tiene creada la base de datos "railway"
-- Este script solo crea las tablas e inserta los datos
-- ===============================
...
SELECT 'Base de datos Railway configurada exitosamente' AS mensaje;
SELECT COUNT(*) as total_alumnos FROM alumnos;
SELECT COUNT(*) as total_resultados FROM resultados WHERE estado = 'VALIDO';
